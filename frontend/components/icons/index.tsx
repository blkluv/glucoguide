...
export default function Icon({ name, className, pathClassName }: Props) {
  switch (name) {
    ...
    case "mail-upload":
      return (
        <MailUploadIcon className={className} pathClassName={pathClassName} />
      )

    case "navigation":
      return (
        <NavigationIcon className={className} pathClassName={pathClassName} />
      )
    ...
    case "spinning-loader":
      return (
        <SpinningLoader className={className} pathClassName={pathClassName} />
      )
    ...
    case "google":
      return <GoogleIcon className={className} pathClassName={pathClassName} />

    case "envelope":
      return (
        <EnvelopeIcon className={className} pathClassName={pathClassName} />
      )
