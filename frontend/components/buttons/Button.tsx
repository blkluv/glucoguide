  ...
  return (
    <motion.button
      ...
      className={`py-2 px-3 inline-flex items-center font-medium gap-x-2 text-sm rounded-lg border border-gray-200 ${className} ${
        ...
        type === "outline" &&
        ` bg-white dark:bg-neutral-300 text-neutral-500 shadow-sm hover:bg-gray-50 dark:hover:bg-neutral-200 focus:outline outline-offset-2 focus:outline-blue-400`
      } ${
        type === "secondary" &&
